...
/** UI state data for the setup progress indicator and its associated bottom sheet. */
data class SetupProgressUiData(
  val progressUiType: ProgressUiType,
  val progressIndeterminate: Boolean = false,
  val progressValue: Int = 0,
  val progressIcon: Bitmap? = null,
  val bottomSheetIcon: Bitmap? = null,
  ...
  val bottomSheetCardIcon: Bitmap? = null,
